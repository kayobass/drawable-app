...
| 12  | `Estrela`                | `src/models/poligonos.py`       |
| 13  | `Poligono`               | `src/models/poligonos.py`       |
| 14  | `Historico`              | `src/models/historico.py`       |
| 15  | `DrawableView`           | `src/views/view.py`             |
| 16  | `DrawableController`     | `src/controllers/controller.py` |
| 17  | `EstadoFerramenta` (ABC) | `src/models/estados.py`         |
| 18  | `EstadoLinha`            | `src/models/estados.py`         |
| 19  | `EstadoRabisco`          | `src/models/estados.py`         |
| 20  | `EstadoFigura`           | `src/models/estados.py`         |
| 21  | `EstadoPoligono`         | `src/models/estados.py`         |
| 22  | `EstadoSelecao`          | `src/models/estados.py`         |
...
| `Historico`           | `__init__`, `adicionar`, `inserir`, `remover`, `registrar_mudanca_atributo`, `registrar_posicao`, `registrar_movimentacao`, `desfazer`, `refazer`, `limpar`, `figuras`, `figuras_desfeitas` | 12  |
...
| `EstadoFigura`   | Oval, Círculo, Retângulo, Quadrado, Triângulos, Pentágono, Hexágono, Estrela |
